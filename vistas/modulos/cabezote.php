	...
	======================================-->
 	<a href="inicio" class="logo">
 		...
 		<span class="logo-lg">
 			...
 			<img src="vistas/img/plantilla/icono-largo-menu.png" class="img-responsive" style="padding: 10px;" width="350px">
 			...
 			<ul class="nav navbar-nav">
 				...
 				<li class="dropdown user user-menu">
 					...
 					<a href="#" class="dropdown-toggle" data-toggle="dropdown">
 						...
 						<span class="hidden-xs"><?php echo $_SESSION["datos_completos"]; ?></span>
