    ...
    public function mostrarTablaTicket() {
        ...
        if ($_SESSION["perfil"] == "Administrador") {
		  ...
		  "data": [';
            ...
            $item3 = "id_estado";
            $valor3 = 4;
            $ticket = ControladorTicketInactivo::ctrMostrarTicket_usuario($item, $item2, $valor, $item3, $valor3);
		  ...
		  "data": [';
            ...
            $item3 = "id_estado";
            $valor3 = 4;
            $ticket = ControladorTicketInactivo::ctrMostrarTicket_informatico($item, $item2, $valor, $item3, $valor3);
